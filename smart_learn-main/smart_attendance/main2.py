...
# Add all known faces to the attendance DataFrame with status 'Present'
for name in known_face_names:
  attendance = pd.concat([attendance, pd.DataFrame([{'Name': name, 'Time': None, 'Status': 'Present'}])], ignore_index=True)
...
# Mark any individual who was not recognized as 'Absent'
attendance.loc[attendance['Status'] == 'Present' and attendance['Time'].isnull(), 'Status'] = 'Absent'
